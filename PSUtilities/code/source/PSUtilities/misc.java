...
// -----( CREATED: 2004-11-15 23:04:25 PST
// -----( ON-HOST: 192.168.0.3
...

{
  ...
  static misc _newInstance()
  {
    return new misc();
  }

  static misc _cast(Object o)
  {
    return (misc) o;
  }
  ...
  public static final void appendObjectList(IData pipeline) throws ServiceException
  {
  ...
  public static final void appendStringListToStringTable(IData pipeline) throws ServiceException
  {
  ...
  public static final void collectGarbage(IData pipeline) throws ServiceException
  {
  ...
  public static final void deepCopy(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(deepCopy)>> ---
    // @sigtype java 3.5
  ...
  public static final void doInvoke(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(doInvoke)>> ---
    // @sigtype java 3.5
  ...
  public static final void getHostInformation(IData pipeline) throws ServiceException
  {
  ...
  public static final void getRecordElements(IData pipeline) throws ServiceException
  {
  ...
  public static final void getServerConfigParameters(IData pipeline) throws ServiceException
  {
  ...
  public static final void getServerInformation(IData pipeline) throws ServiceException
  {
  ...
  public static final void getUser(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(getUser)>> ---
    // @sigtype java 3.5
  ...
  public static final void invokeAndCatchErrors(IData pipeline) throws ServiceException
  {
  ...
  public static final void makeSystemCall(IData pipeline) throws ServiceException
  {
  ...
  public static final void println(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(println)>> ---
    // @sigtype java 3.5
  ...
  public static final void spawnThread(IData pipeline) throws ServiceException
  {
  ...
  public static final void spawnThread2(IData pipeline) throws ServiceException
  {
