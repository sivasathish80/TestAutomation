...

{
  ...
  static session _newInstance()
  {
    return new session();
  }

  static session _cast(Object o)
  {
    return (session) o;
  }
  ...
  public static final void clearSession(IData pipeline) throws ServiceException
  {
  ...
  public static final void getObjectFromSession(IData pipeline) throws ServiceException
  {
  ...
  public static final void getSessionID(IData pipeline) throws ServiceException
  {
  ...
  public static final void getSessionKeys(IData pipeline) throws ServiceException
  {
  ...
  public static final void putObjectInSession(IData pipeline) throws ServiceException
  {
  ...
  public static final void removeObjectFromSession(IData pipeline) throws ServiceException
  {
