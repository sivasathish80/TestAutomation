...
// -----( CREATED: 2005-06-10 11:55:18 PDT
...

{
  ...
  static file _newInstance()
  {
    return new file();
  }

  static file _cast(Object o)
  {
    return (file) o;
  }
  ...
  public static final void bytesToFile(IData pipeline) throws ServiceException
  {
  ...
  public static final void checkFileExistence(IData pipeline) throws ServiceException
  {
  ...
  public static final void copyFile(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(copyFile)>> ---
    // @sigtype java 3.5
    // [i] field:0:required filename
  ...
  public static final void getBasename(IData pipeline) throws ServiceException
  {
  ...
  public static final void getMimeType(IData pipeline) throws ServiceException
  {
  ...
  public static final void listFiles(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(listFiles)>> ---
    // @subtype unknown
    // @sigtype java 3.5
  ...
  public static final void moveFile(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(moveFile)>> ---
    // @sigtype java 3.5
  ...
  public static final void objectToFile(IData pipeline) throws ServiceException
  {
  ...
  public static final void streamToFile(IData pipeline) throws ServiceException
  {
  ...
  public static final void writeToFile(IData pipeline) throws ServiceException
  {
