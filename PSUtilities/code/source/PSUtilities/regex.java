...

{
  ...
  static regex _newInstance()
  {
    return new regex();
  }

  static regex _cast(Object o)
  {
    return (regex) o;
  }
  ...
  public static final void find(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(find)>> ---
    // @subtype unknown
    // @sigtype java 3.5
  ...
  public static final void lookingAt(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(lookingAt)>> ---
    // @subtype unknown
    // @sigtype java 3.5
  ...
  public static final void matches(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(matches)>> ---
    // @subtype unknown
    // @sigtype java 3.5
  ...
  public static final void replaceAll(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(replaceAll)>> ---
    // @subtype unknown
    // @sigtype java 3.5
  ...
  public static final void replaceFirst(IData pipeline) throws ServiceException
  {
  ...
  public static final void split(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(split)>> ---
    // @subtype unknown
    // @sigtype java 3.5
  ...
  public static final void splitLimit(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(splitLimit)>> ---
    // @subtype unknown
    // @sigtype java 3.5
