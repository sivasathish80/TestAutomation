...

{
  ...
  static zip _newInstance()
  {
    return new zip();
  }

  static zip _cast(Object o)
  {
    return (zip) o;
  }
  ...
  public static final void unzipFiles(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(unzipFiles)>> ---
    // @sigtype java 3.5
  ...
  public static final void zipFiles(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(zipFiles)>> ---
    // @sigtype java 3.5
